    ...
    <div class="container-alfabet">
      ...
      <div id ="audio">
        <audio autoplay hidden>
          <source src="audio/p.mp3" type="audio/ogg">
        </audio>
      ...
      <div class = "btn-container">
        <a id = "btn_Previous" href = "alfabet-o.php"><img src="imgs/previous.png"</i></a>
      	<a id = "btn_Next" href = "alfabet-q.php"><img src="imgs/next.png"</i></a>
      </div>

      <div id ="container-letter">
        <img class ="letter_A" src="imgs/letter_P-01.png">
        <h1 class = "letter_Word"> Paard </h1>
      </div>
