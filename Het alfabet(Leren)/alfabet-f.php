  ...
  <body>
    ...
    <div class="container-alfabet">
      ...
      <div class = "btn-container">
        <a id = "btn_Previous" href = "alfabet-e.php"><img src="imgs/previous.png"</i></a>
      	<a id = "btn_Next" href = "alfabet-g.php"><img src="imgs/next.png"</i></a>
      </div>

      <div id ="container-letter">
        <img class ="letter_A" src="imgs/letter_F-01.png">
        <h1 class = "letter_Word"> Fiets </h1>
      </div>
