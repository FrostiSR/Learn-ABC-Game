  ...
  <body>
    ...
    <div class="container-alfabet">
      ...
      <div class = "btn-container">
        <a id = "btn_Previous" href = "alfabet-x.php"><img src="imgs/previous.png"</i></a>
      	<a id = "btn_Next" href = "alfabet-z.php"><img src="imgs/next.png"</i></a>
      </div>

      <div id ="container-letter">
        <img class ="letter_A" src="imgs/letter_Y-01.png">
        <h1 class = "letter_Word"> Yoghurt </h1>
      </div>
