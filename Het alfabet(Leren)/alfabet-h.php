  ...
  <body>
    ...
    <div class="container-alfabet">
      ...
      <div class = "btn-container">
        <a id = "btn_Previous" href = "alfabet-g.php"><img src="imgs/previous.png"</i></a>
      	<a id = "btn_Next" href = "alfabet-i.php"><img src="imgs/next.png"</i></a>
      </div>

      <div id ="container-letter">
        <img class ="letter_A" src="imgs/letter_H-01.png">
        <h1 class = "letter_Word"> Hond </h1>
      </div>
