    ...
    <div class="container-alfabet">
      ...
      <div class="overlay" id="overlay">
        <nav class="overlay-menu">
            <a "../Start scherm/startscherm.php">
      ...
      <div id ="audio">
        <audio autoplay hidden>
          <source src="audio/i.mp3" type="audio/ogg">
        </audio>
      ...
      <div class = "btn-container">
        <a id = "btn_Previous" href = "alfabet-h.php"><img src="imgs/previous.png"</i></a>
      	<a id = "btn_Next" href = "alfabet-j.php"><img src="imgs/next.png"</i></a>
      </div>

      <div id ="container-letter">
        <img class ="letter_A" src="imgs/letter_I-01.png">
        <h1 class = "letter_Word"> Inktvis </h1>
      </div>
